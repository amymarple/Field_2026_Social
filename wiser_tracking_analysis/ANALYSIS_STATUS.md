...
| Sleep-site WISER↔CV cross-val (Direction 3) | `scripts/analyze_sleep_site_cv_crossval.py` | ⚠️ | Shelter-occupancy agreement vs CV (CH05/CH06); nominal mapping confirmed (joint κ=0.66); 6/29 κ 0.68–0.82 | Only the 2 shelters; clock residual ~0 but unverified; clear-glass stratum degenerate on these 2 days; CV misses huddles under wet glass (6/30) | [plan](../implementation_plan/2026-07-02-sleep-site-cv-crossval.md) · [log](../change_log/2026-07-02-sleep-site-cv-crossval.md) |
